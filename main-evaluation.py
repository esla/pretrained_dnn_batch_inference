...
if __name__ == '__main__':
    ...
    if args.inference_only:
        ...
        if args.validate_train_dataset:
            all_results_df, metrics = test_model(net, train_loader, class_dict, is_validation_mode=True)
        else:
        ...
        print(f"inference dataset: {args.inference_dataset_dir}")
        print(f"result filenane: {filename}")
